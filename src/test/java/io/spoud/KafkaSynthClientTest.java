...
public class KafkaSynthClientTest {
    ...
    public void testEndToEndLatencyRecorded() {
        ...
        assertThat(metrics).contains("synth_client_e2e_latency_ms{broker=\"0\",fromRack=\"dc1\",partition=\"0\",toRack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.5\"}");
        assertThat(metrics).contains("synth_client_e2e_latency_ms{broker=\"0\",fromRack=\"dc1\",partition=\"0\",toRack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.9\"}");
        assertThat(metrics).contains("synth_client_e2e_latency_ms{broker=\"0\",fromRack=\"dc1\",partition=\"0\",toRack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.95\"}");
        assertThat(metrics).contains("synth_client_e2e_latency_ms{broker=\"0\",fromRack=\"dc1\",partition=\"0\",toRack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.99\"}");
    ...
    public void testAckLatencyRecorded() {
        ...
        assertThat(metrics).contains("synth_client_ack_latency_ms{broker=\"0\",partition=\"0\",rack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.5\"}");
        assertThat(metrics).contains("synth_client_ack_latency_ms{broker=\"0\",partition=\"0\",rack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.9\"}");
        assertThat(metrics).contains("synth_client_ack_latency_ms{broker=\"0\",partition=\"0\",rack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.95\"}");
        assertThat(metrics).contains("synth_client_ack_latency_ms{broker=\"0\",partition=\"0\",rack=\"dc1\",viaBrokerRack=\"unknown\",quantile=\"0.99\"}");
